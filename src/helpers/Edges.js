      ...
      if (map[modesKey] & DELETEPOINT) {
        const deleteMarker = () => {
          ...
          document
            ...
            .removeEventListener("click", deleteMarker);
          document
            .getElementById("cancelPopupButton")
            .removeEventListener("click", closeMarkerPopup);
        ...
        const contentPopup = L.popup().setContent(
          "<b>Delete marker?</b><br><br> &nbsp; <button id='popupButton'> Yes </button> &nbsp; <button id='cancelPopupButton'> No </button>"
        );
        ...
        document
          .getElementById("cancelPopupButton")
          .addEventListener("click", closeMarkerPopup);
